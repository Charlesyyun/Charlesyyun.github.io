...
[查看论文](https://doi.org/10.1016/j.trip.2026.102041)

**引用:** Che, Y., Wong, M.O., Gao, X., Liang, H., & Ye, Y.* (2026). "Enhancing safety in automated ports: A virtual reality study of pedestrian–autonomous vehicle interactions under time pressure, visual constraints, and varying vehicle size." <i>Transportation Research Interdisciplinary Perspectives</i>, 37, 102041.
