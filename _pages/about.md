...
## Journal Papers
### Human Factors, VR and Human–Automation Interaction
...
* Che, Y., Wong, M.O., Gao, X., Liang, H., & **Ye, Y.**\* (2026). [Enhancing safety in automated ports: A virtual reality study of pedestrian–autonomous vehicle interactions under time pressure, visual constraints, and varying vehicle size](https://doi.org/10.1016/j.trip.2026.102041). *Transportation Research Interdisciplinary Perspectives*, in press. (**EI, ESCI, JCR Q2, IF 3.8**)

### Maritime Safety, Risk Modelling and Resilience
...
### AI-enabled Transport and Engineering Systems
