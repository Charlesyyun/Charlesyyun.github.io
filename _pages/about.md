...
## Journal Papers
 * **Ye, Y.**, Liu, M., Meng, F., Wong, S.C., Gao, X.\*, & Yang, Z. (2026). Temporal instability analysis of fatal commercial fishing vessel incidents: A correlated random-parameter model with heterogeneity in means. *Reliability Engineering & System Safety*, in press. (**SCI, JCR Q1, IF 11.0**)
 * **Ye, Y.**, Zhou, Z., Ying, C., Xie, J., Chen, X., & Gao, Z.\* (2026). [Risk-aware pedestrian-vehicle interaction: A multi-objective Bayesian optimized social force model](https://doi.org/10.1080/23249935.2026.2627403). *Transportmetrica A: Transport Science*, in press. (**SCI/SSCI, JCR Q2, IF 3.1**)
