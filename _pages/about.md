...
## Journal Papers
 * **Ye, Y.**, Liu, M., Meng, F., Wong, S.C., Gao, X.\*, & Yang, Z. (2026). [Temporal instability analysis of fatal commercial fishing vessel incidents: A correlated random-parameter model with heterogeneity in means](https://doi.org/10.1016/j.ress.2026.112423). *Reliability Engineering & System Safety*, in press. (**SCI, JCR Q1, IF 11.0**)
